...
export const metadata: Metadata = {
  title: "Free Name Arabic Generator Online - Xonix Tech",
  description: "Use our free name Arabic generator to transliterate your name into Arabic script. Convert English names to Arabic with accurate pronunciation and cultural context. Easy-to-use online name Arabic generator tool.",
  keywords: [
    "name arabic generator",
    "name arabic transliterator",
    "english to arabic name converter",
    "arabic name transliteration",
    "name arabic script generator",
    "online name arabic generator",
    "free name arabic generator",
    "name transliteration tool",
    "arabic name converter",
    "name to arabic script",
    "arabic transliteration generator",
    "english name in arabic",
    "arabic name transliterator",
    "name arabic writing generator",
    "arabic script name generator",
    "transliterate name to arabic",
    "name in arabic letters",
    "arabic name writing tool",
    "name arabic online generator",
    "free name transliteration service"
  ],
  openGraph: {
    title: "Free Name Arabic Generator Online - Xonix Tech",
    description: "Use our free name Arabic generator to transliterate your name into Arabic script. Convert English names to Arabic with accurate pronunciation and cultural context.",
    type: "website",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Free Name Arabic Generator Online - Transliterate Names to Arabic Script",
      },
    ],
  },
  twitter: {
